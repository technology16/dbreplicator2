...
insert into runners (id, source, target, description, class_name) values (2, 'source', 'source', 'description', 'ru.taximaxim.dbreplicator2.replica.ReplicaRunner')

--Strategies Dummy Strategy
insert into strategies (id, className, param, isEnabled, priority, id_runner) values (2, 'ru.taximaxim.dbreplicator2.replica.strategies.DummyStrategy', null, true, 100, 2)
