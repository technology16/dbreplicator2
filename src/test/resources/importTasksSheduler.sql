...
--Tables
insert into tables (name, id_runner, param) values ('T_TABLE1', 2, 'ignoredCols=_STRING');
...
--sleep_after_start
insert into tasks (id_task, id_runner, enabled, success_interval, fail_interval, description) values (1, 1, true, 1000, 300000, 'FastManager');
