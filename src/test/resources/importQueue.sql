...
insert into tables (name, id_runner, param) values ('T_TABLE6', 25, null);
insert into tables (name, id_runner, param) values ('T_TABLE7', 25, null);
insert into tables (name, id_runner, param) values ('T_TABLE8', 25, null);
