...
CREATE TABLE rep2_workpool_data(id_runner INTEGER NOT NULL, id_superlog BIGINT NOT NULL, id_foreign INTEGER, id_table NVARCHAR, c_operation VARCHAR(1), c_date TIMESTAMP, id_transaction NVARCHAR);
